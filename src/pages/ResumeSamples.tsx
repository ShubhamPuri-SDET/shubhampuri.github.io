...
const ResumeSamples: React.FC = () => {
  ...
  return (
    <div className="bg-background">
            ...
            {stats.map((stat, index) => (
              <div key={index} className="text-center p-4">
                <div className="flex justify-center mb-3">
                  <div className="bg-primary-100 dark:bg-primary-900/30 p-3 sm:p-4 rounded-full">
                    <stat.icon className="h-6 w-6 sm:h-8 sm:w-8 text-primary-600 dark:text-primary-400" />
                  </div>
                </div>
                <div className="text-3xl sm:text-4xl font-bold text-primary-600 dark:text-primary-400 mb-2">{stat.value}</div>
      ...
      {/* CTA Section */}
      <div className="py-12 sm:py-16 bg-gradient-to-r from-primary-600 to-primary-700">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 max-w-md sm:max-w-none mx-auto">
            <Link
              to="/quote"
              className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-white text-primary-600 rounded-lg font-semibold hover:bg-primary-50 transition-colors shadow-lg text-center"
            >
              Get Your Free Quote
            </Link>
            <Link
              to="/services"
              className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-primary-800 text-white rounded-lg font-semibold hover:bg-primary-900 transition-colors text-center"
            >
              View All Services
            </Link>
          </div>
      ...
      {/* Trust Indicators */}
      <div className="py-10 sm:py-12 bg-slate-50 dark:bg-slate-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
            <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-0">
              <CheckCircle className="h-5 w-5 sm:h-6 sm:w-6 text-green-500 flex-shrink-0 mt-1" />
              <div>
                <h3 className="font-semibold text-base sm:text-lg text-foreground mb-1 sm:mb-2">ATS-Optimized</h3>
            ...
            <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-0">
              <CheckCircle className="h-5 w-5 sm:h-6 sm:w-6 text-green-500 flex-shrink-0 mt-1" />
              <div>
                <h3 className="font-semibold text-base sm:text-lg text-foreground mb-1 sm:mb-2">Industry Experts</h3>
                <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400">
            ...
            <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-0">
              <CheckCircle className="h-5 w-5 sm:h-6 sm:w-6 text-green-500 flex-shrink-0 mt-1" />
              <div>
                <h3 className="font-semibold text-base sm:text-lg text-foreground mb-1 sm:mb-2">Unlimited Revisions</h3>
                <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400">
            ...
            <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-0">
              <CheckCircle className="h-5 w-5 sm:h-6 sm:w-6 text-green-500 flex-shrink-0 mt-1" />
              <div>
                <h3 className="font-semibold text-base sm:text-lg text-foreground mb-1 sm:mb-2">Fast Turnaround</h3>
                <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400">
